    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-white">{currentWeekStats.riskScore}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-white">{currentWeekStats.totalThreats}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-white">{currentWeekStats.criticalIncidents}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-white">{currentWeekStats.vulnerabilitiesPatched}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-white">{currentWeekStats.systemUptime}%</div>
            <p className="text-xs text-muted-foreground">This week</p>
          </CardContent>
        </Card>
      </div>
