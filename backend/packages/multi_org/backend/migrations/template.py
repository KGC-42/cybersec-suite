...
down_revision = None  # Set this to your last migration
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    # Add org_id to existing tables (optional - uncomment if needed)
...
def downgrade():
    # Remove org_id from existing tables (if added)
